...
<div class="container pl-0 pr-0">
	<div class="section-title pb-3 pr-2 pt-2">
		...
		<a href="" style="color: #555 !important; text-decoration: none;font-size: 1.1em;"><?php echo $categories[$categoryId-1]['name']; ?></a>
	</div>
		...
		<div class="col-md-3 p-0 pr-3 pb-4">
			...
			<div class="filtr mt-4 pr-0">
				...
				<div class="slidecontainer">
					<input min="1" max="174990" step="1" class="sliders" id="myRange" type="range" data-id="<?php echo $categoryId; ?>" oninput="myRange(this.value)">
				</div>
			</div>
		</div>
		<div class="col-md-9 p-0">
			<div class="section2">
				<div class="row mr-0 ml-0" id="filtrProducts">
					<?php foreach ($categoryProducts as $productsCat): ?>
